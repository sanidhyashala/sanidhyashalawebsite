        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Link
              ...
              className="rounded-2xl border bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg dark:bg-slate-900 dark:border-slate-800 dark:shadow-none dark:hover:border-slate-700 dark:hover:shadow-lg dark:hover:shadow-black/30"
            >
            ...
            <Link
              ...
              className="rounded-2xl border bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg md:col-span-2 dark:bg-slate-900 dark:border-slate-800 dark:shadow-none dark:hover:border-slate-700 dark:hover:shadow-lg dark:hover:shadow-black/30"
            >
              <h2 className="mb-3 text-2xl font-bold text-blue-900 dark:text-blue-400">
