    ...
    <main className="px-6 py-16">
      <div className="mx-auto max-w-5xl">
        <h1 className="mb-4 text-5xl font-bold text-blue-900 dark:text-blue-400">
          Class X Previous Year Questions
        </h1>

        <p className="mb-12 text-lg text-slate-600 dark:text-slate-400">
          Chapter-wise collection of important board examination questions
          from previous years for focused revision and exam preparation.
        </p>
